    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12 items-center">
          ...
          <div className="bg-gray-300 h-64 md:h-72 rounded-lg">
            {/* Image */}
            <img
    src={img7}
          ...
          {reviews.map((review, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-gray-300 border-2 border-amber-500 mr-4"></div>
                <div>
              ...
              <p className="text-gray-500 text-sm bg-gray-50 p-3 rounded">{review.message}</p>
            </div>
          ))}
        </div>
      </div>
